...
import { GETALLSTORES_API,CUSTOMER_REPORT_API,ORDER_STATUS_API,PAYMENT_REPORT_API,GET_INVENTORY_FILE_API,GET_INVENTORY_FILE_UPL_API,GET_ALL_ORDERS,GET_ORDER_REPORT} from '../../Constants/apiRoutes'
      ...
      fetch(downloadUrl)
        ...
        .then((data) => {
          ...
          if (downloadUrl) {
            ...
            toast.error('Download URL is not available for the uploaded file.', {
              position: "top-right",
              autoClose: 5000,
              hideProgressBar: false,
              closeOnClick: true,
        ...
        .catch((error) => {
          console.error('Error:', error);
          toast.error('Failed to download the file using the uploaded file ID.', {
            position: "top-right",
            autoClose: 5000,
            hideProgressBar: false,
            closeOnClick: true,
